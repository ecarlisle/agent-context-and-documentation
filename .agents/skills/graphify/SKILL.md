---
name: graphify
description: "Build, update, query, or export a knowledge graph when the user invokes /graphify or explicitly requests Graphify operations. General project questions use the repository task guides."
---
