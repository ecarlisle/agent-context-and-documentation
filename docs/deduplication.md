...
- **Instructions**: [AGENTS.md](../AGENTS.md) is the single source of truth. A tool that expects its own instruction file (`CLAUDE.md`, `.github/copilot-instructions.md`, `.gemini/settings.json`, ...) gets a thin pointer back to `AGENTS.md`, not a duplicated copy. See [README.md](../README.md#agent-compatibility-shims) for the current shim list.
